...
public class IzmjenaKlijentaForm {

	protected Shell shlIzmjenaFizikogLica;
	private Table table;
	private Text text;
	private Text text_1;
	private Text text_2;
	...
	public static void main(String[] args) {
		try {
			IzmjenaKlijentaForm window = new IzmjenaKlijentaForm();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void open() {
		...
		createContents();
		shlIzmjenaFizikogLica.open();
		shlIzmjenaFizikogLica.layout();
		while (!shlIzmjenaFizikogLica.isDisposed()) {
	...
	protected void createContents() {
		shlIzmjenaFizikogLica = new Shell();
		shlIzmjenaFizikogLica.setImage(SWTResourceManager.getImage("src/1396674421_Streamline-61.png"));
		shlIzmjenaFizikogLica.setSize(631, 490);
		shlIzmjenaFizikogLica.setText("Izmjena fizi\u010Dkog lica");
		
		table = new Table(shlIzmjenaFizikogLica, SWT.BORDER | SWT.FULL_SELECTION);
		...
		Group group = new Group(shlIzmjenaFizikogLica, SWT.NONE);
		...
		Label lblOznaiteKlijenta = new Label(shlIzmjenaFizikogLica, SWT.NONE);
		lblOznaiteKlijenta.setText("Ozna\u010Dite \u017Eeljenog klijenta:");
		lblOznaiteKlijenta.setBounds(10, 128, 154, 15);
		
		Group group_1 = new Group(shlIzmjenaFizikogLica, SWT.NONE);
		...
		Button button_1 = new Button(shlIzmjenaFizikogLica, SWT.NONE);
		button_1.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				shlIzmjenaFizikogLica.close();
			}
		});
		button_1.setText("OK");
		...
		Button button_2 = new Button(shlIzmjenaFizikogLica, SWT.NONE);
