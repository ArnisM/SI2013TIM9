...
public class IzmjenaPonudeTrenutneForm {
	...
	public static void main(String[] args) {
		try {
			IzmjenaPonudeTrenutneForm window = new IzmjenaPonudeTrenutneForm();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	protected void createContents() {
		...
		shlIzmjenaTrenutne.setImage(SWTResourceManager.getImage("src/1396674680_document_text.png"));
		shlIzmjenaTrenutne.setSize(697, 677);
		shlIzmjenaTrenutne.setText("Izmjena ponude");
