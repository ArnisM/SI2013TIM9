...
public class DodavanjeNovePonudeForm {

	protected Shell shlDodavanjeNovePonude;
	private Table table;
	private Text text;
	...
	public static void main(String[] args) {
		try {
			DodavanjeNovePonudeForm window = new DodavanjeNovePonudeForm();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void open() {
		...
		createContents();
		shlDodavanjeNovePonude.open();
		shlDodavanjeNovePonude.layout();
		while (!shlDodavanjeNovePonude.isDisposed()) {
	...
	protected void createContents() {
		shlDodavanjeNovePonude = new Shell();
		shlDodavanjeNovePonude.setImage(SWTResourceManager.getImage("src/1396674680_document_text.png"));
		shlDodavanjeNovePonude.setSize(697, 677);
		shlDodavanjeNovePonude.setText("Dodavanje nove ponude");
		
		Group grpKlijent = new Group(shlDodavanjeNovePonude, SWT.NONE);
		...
		Label lblStavkeFakture = new Label(shlDodavanjeNovePonude, SWT.NONE);
		lblStavkeFakture.setBounds(10, 158, 132, 15);
		lblStavkeFakture.setText("Dodavanje stavki ponude:");
		
		table = new Table(shlDodavanjeNovePonude, SWT.BORDER | SWT.FULL_SELECTION);
		...
		Button btnNewButton = new Button(shlDodavanjeNovePonude, SWT.NONE);
		...
		Button button = new Button(shlDodavanjeNovePonude, SWT.NONE);
		...
		Button button_1 = new Button(shlDodavanjeNovePonude, SWT.NONE);
		...
		Button button_2 = new Button(shlDodavanjeNovePonude, SWT.NONE);
		button_2.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				shlDodavanjeNovePonude.close();
			}
		});
		...
		text = new Text(shlDodavanjeNovePonude, SWT.BORDER);
		text.setBounds(10, 441, 611, 135);
		
		Label lblDodatniZahtjeviVezani = new Label(shlDodavanjeNovePonude, SWT.NONE);
