...
public class DodavanjeStavkiPonudeForm {
	...
	public static void main(String[] args) {
		try {
			DodavanjeStavkiPonudeForm window = new DodavanjeStavkiPonudeForm();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	protected void createContents() {
		...
		shlDodavanjeStavkiFakture.setText("Dodavanje stavki ponude");
