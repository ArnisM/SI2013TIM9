...
public class DodavanjeKlijentaForm {

	protected Shell shlDodavanjeKlijenta;
	private Text text;
	private Text text_1;
	private Text text_2;
	private Text text_3;
	...
	public static void main(String[] args) {
		try {
			DodavanjeKlijentaForm window = new DodavanjeKlijentaForm();
			window.open();
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void open() {
		...
		createContents();
		shlDodavanjeKlijenta.open();
		shlDodavanjeKlijenta.layout();
		while (!shlDodavanjeKlijenta.isDisposed()) {
	...
	protected void createContents() {
		shlDodavanjeKlijenta = new Shell();
		shlDodavanjeKlijenta.setImage(SWTResourceManager.getImage("src/1396674421_Streamline-61.png"));
		shlDodavanjeKlijenta.setSize(354, 488);
		shlDodavanjeKlijenta.setText("Dodavanje klijenta");
		
		TabFolder tabFolder = new TabFolder(shlDodavanjeKlijenta, SWT.NONE);
