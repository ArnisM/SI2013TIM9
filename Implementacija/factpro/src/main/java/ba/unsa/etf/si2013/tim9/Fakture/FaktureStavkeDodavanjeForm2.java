...
public class FaktureStavkeDodavanjeForm2 extends Shell {
...
//	protected Shell this;
	...
	private FaktureTrenutnaIzmjenaForm z;
	private List list;
	
	public static void main(String args[]) {
		try {
			Display display = Display.getDefault();
			FaktureStavkeDodavanjeForm2 shell = new FaktureStavkeDodavanjeForm2(display,null,null);
			shell.open();
			shell.layout();
	...
	public FaktureStavkeDodavanjeForm2(Display display , ArrayList<String> a, FaktureTrenutnaIzmjenaForm f) {
