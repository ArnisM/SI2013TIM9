...
//import org.eclipse.wb.swt.IzmjenaPonudeTrenutneForm;
...
//		this = new Shell();
		this.setImage(SWTResourceManager.getImage(PonudeIzmjenaForm.class, "/images/1396674680_document_text.png"));
		...
		btnIzmjeni.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent e) {
				PonudeTrenutnaIzmjenaForm a = new PonudeTrenutnaIzmjenaForm (null);
				a.open();
