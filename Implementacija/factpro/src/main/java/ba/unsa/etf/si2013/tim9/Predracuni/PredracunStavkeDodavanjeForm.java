...
import java.util.ArrayList;
public class PredracunStavkeDodavanjeForm extends Shell {
...
//	protected Shell this;
	...
	private PredracunDodavanjeForm z;
	private List list;
	
	public static void main(String args[]) {
		try {
			Display display = Display.getDefault();
			PredracunStavkeDodavanjeForm shell = new PredracunStavkeDodavanjeForm(display,null,null);
			shell.open();
			shell.layout();
	...
	public PredracunStavkeDodavanjeForm(Display display , ArrayList<String> a, PredracunDodavanjeForm f) {
...
//		this = new Shell();
		this.setImage(SWTResourceManager.getImage(PredracunStavkeDodavanjeForm.class, "/images/1396674611_invoice.png"));
		...
		button.setImage(SWTResourceManager.getImage(PredracunStavkeDodavanjeForm.class, "/images/1398195801_tick_32.png"));
		...
		button_1.setImage(SWTResourceManager.getImage(PredracunStavkeDodavanjeForm.class, "/images/1398195841_DeleteRed.png"));
